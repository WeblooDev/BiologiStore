            ...
            <div className="  py-12 px-6 bg-[#F6F6F6]  justify-between items-start  gap-8 border-b border-gray-300">
              <div className="container m-auto flex flex-col md:flex-row gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <p className="text-base !text-lg text-[#2B8C57] font-poppins">
                    Keep In Touch With BiologiMd®
                  </p>
                  <p className="!text-sm">
                    Join the BiologiMD® newsletter. Sign up to be the first to
                    access new skincare launches, expert tips, and exclusive
                    offers.
                  </p>
                  <form className="flex items-center gap-6">
                    ...
                    <button
                      type="submit"
                      className=" bg-[#2B8C57] font-poppins text-white px-6 py-3 uppercase"
                    >
                      Sign up
                    </button>
                  </form>
                  ...
                  <div>
                    <p className="text-[#2B8C57] font-poppins !m-0 !text-lg">
                      Follow BiologiMD®
                    </p>
                ...
                <div className="md:w-1/2 flex justify-around gap-5">
                  <div className="flex flex-col gap-3">
                    <h1 className="text-[#2B8C57] font-poppins !m-0 !text-lg">
                      About
                    </h1>
                    ...
                    <a className="font-poppins" href="/Blog">
                      Blog
                    </a>
                  </div>
